...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    ...
    "img-src 'self' data: blob: https://*.supabase.co https://maps.googleapis.com https://maps.gstatic.com https://streetviewpixels-pa.googleapis.com https://mts0-4.googleapis.com https://khms0-4.googleapis.com",
    "connect-src 'self' https://*.supabase.co https://challenges.cloudflare.com https://vitals.vercel-insights.com https://va.vercel-scripts.com https://maps.googleapis.com https://maps.gstatic.com https://*.googleapis.com https://csi.gstatic.com https://mts0.googleapis.com https://mts1.googleapis.com https://mts2.googleapis.com https://mts3.googleapis.com https://mts4.googleapis.com https://mts5.googleapis.com",
